...
class BDTHelpers(object):
    ...
    def compute_roc(self):
        ...
        for i in range(100):
          print(self.y_train[i], self.y_pred_train[i], self.train_weights_eq[i])

        bkgEff, sigEff, nada = roc_curve(self.y_train, self.y_pred_train, sample_weight=self.train_weights)
        #plt.figure(1)
